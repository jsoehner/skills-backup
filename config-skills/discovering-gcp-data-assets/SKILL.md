...
>full_qualified_name qualifier. - **Fallback 2**: Use native tools (e.g.,\\
...
> 3.  **Single Result:** Proceed to Step 4 using the full entry name.\\
...
> `projects/`) returned by the search result. Passing short table names, GCS URIs,\\
