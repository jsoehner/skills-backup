...
- Before initiating any video generation workflow, you **MUST** run the targeted `npx hyperframes skills update <workflow-name>` command.

- **Do NOT load** core domain reference sub-files during the initial input verification phase to save tokens.
