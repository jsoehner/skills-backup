...
- Before creating a slide deck, you **MUST** read [references/presentations.md](references/presentations.md) fully.

- Before designing web interfaces, you **MUST** read [references/web-and-react.md](references/web-and-react.md).

- **Do NOT load** presentations reference files for web app tasks to save context tokens.



### Dark Mode Overrides & Viewport Sizing Tests

1. **System theme overrides**: When enforcing the Neon rich black canvas mode, block browser-level or OS-level system theme color overrides to prevent style breakage.
