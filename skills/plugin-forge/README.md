...
A comprehensive skill for building and managing AI coding agent plugins with proper structure, manifests, and marketplace integration.

## Purpose

Plugin Forge streamlines the entire lifecycle of AI coding agent plugin development. It provides automation scripts, reference documentation, and structured workflows to help you create professional-quality plugins that integrate seamlessly with the AI coding agent plugin ecosystem.
...
- **Create new plugins** - "Create a new AI coding agent plugin for my project"
...
**Trigger phrases:**
- "Create a AI coding agent plugin"
...
- **AI coding agent** - For testing and using plugins
...
- Restart AI coding agent after reinstalling to ensure changes take effect
- AI coding agent caches plugin files, so reinstallation is needed for updates
...
AI coding agent caches plugin files. After reinstalling:
1. Restart AI coding agent completely
