...
| Meme usage in incident channels | Inappropriate humor ruins trust during system crashes | Keep conversations strictly technical during outages |

| Raw API calls in Python scripts | Standard API outputs lack validation parameters | Always route through the `meme_generator.py` script wrapper |
