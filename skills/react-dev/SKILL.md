...
| Avoid | Why | Instead |
|-------|-----|---------|
| Running client checks during SSR | Triggers React hydration mismatch warnings | Wrap window/document logic in `useEffect` blocks |
| Monolithic custom hooks | Hard to mock and test | Split Hooks into single-responsibility utilities |

## References & Loading Triggers

**MANDATORY - LOADING TRIGGERS**:
- Before implementing React 19 actions, you **MUST** read [react-19-patterns.md](references/react-19-patterns.md) fully.
