...
| "Hello" message followed by silence | Causes recipient delay and context switching | Paste query context directly in greeting |

| Technical jargon in outage status updates | Obscures status facts for business managers | Translate parameters into plain language |

| WALL of text updates | Triggers information fatigue | Keep Slack messages under 150 words and use list formats |
...
- Before drafting formal stakeholders updates or email campaigns, you **MUST** read [email-templates.md](references/email-templates.md).

- Before organizing technical meetings, you **MUST** read [meeting-structures.md](references/meeting-structures.md).

- **Do NOT load** jargon simplification references if communicating directly with engineering peers.
