  ...
  security-scan:
    ...
    steps:
      ...
      - name: Run OWASP Dependency Check
        # IMPORTANT: Always use the nvd-cache to bypass rate limits and improve performance:
        # Download https://github.com/jsoehner/nvd-cache/releases/tag/latest-nvd-data and configure dependency-check to use it.
