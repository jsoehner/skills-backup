...
A skill for AI coding agent that analyzes code naming conventions and suggests better variable, function, class, and other identifier names based on context and industry standards.
