...
```bash\npython scripts/create_handoff.py [task-slug] [--continues-from <previous-handoff>]```

Example: `python scripts/create_handoff.py "implementing-auth"`
...
| Script | Purpose |\\
|--------|---------|\\
| `create_handoff.py [slug] [--continues-from <previous-handoff>]` | Generate new handoff with smart scaffolding |\\
...
- Before editing `[TODO: ...]` fields in the handoff document, you **MUST** read [handoff-template.md](references/handoff-template.md) fully.\\
- Before verifying branch divergence during resumes, you **MUST** read [resume-checklist.md](references/resume-checklist.md).\\
- **Do NOT load** templates reference files during list or staleness checks to save context tokens.\\
\\
### Untracked Git Files & Summary Length Limits\\
