...
A AI coding agent skill that removes signs of AI-generated writing from text, making it sound more natural and human.

## Installation

### Recommended (clone directly into AI coding agent skills directory)
...
If you already have this repo cloned (or you downloaded `SKILL.md`), copy the skill file into AI coding agent’s skills directory:
...
In AI coding agent, invoke the skill:
