#!/usr/bin/env python3
"""
Get AI coding agent conversation digest for daily standup integration.
...
@dataclass
class Session:
    """Represents a AI coding agent session."""
    id: str
    title: str
    project: str
    branch: Optional[str]
...
def main():
    parser = argparse.ArgumentParser(
        description='Get AI coding agent conversation digest for daily standup'
    )
