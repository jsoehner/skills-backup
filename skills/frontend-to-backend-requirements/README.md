...
A AI coding agent skill for frontend developers to document data needs and API requirements for backend developers in a collaborative, non-prescriptive way.
