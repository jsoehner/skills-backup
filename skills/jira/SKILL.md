...
- Before creating a complex ticket or formatting descriptions, you **MUST** read [commands.md](references/commands.md).

- Before transitioning tickets or assigning account IDs in MCP mode, you **MUST** read [mcp.md](references/mcp.md).

- **Do NOT load** any reference markdown files during the initial backend check stage to save tokens.



### Query Limits & Temporary File Cleanup
