...
Both companion skills are installed locally and auto-discovered by AI coding agent at session start. **You MUST load and apply their guidelines** — this skill is the *editorial* layer on top of them, not a replacement.
