...
| Avoid | Why | Instead |
|-------|-----|---------|
| Generalizations ("always", "never") | Triggers immediate defensiveness | Use specific facts and situation parameters |
| Public Feedback Delivery | Causes public embarrassment, ruins trust | Deliver critical feedback in private 1:1 sessions |
| Feedback Overlap | Confuses team on escalation channels | For complex performance plans, refer to `difficult-workplace-conversations` |
