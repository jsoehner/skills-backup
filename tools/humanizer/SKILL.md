...
| Outputting meta logs | "Changes made" blocks leak prompt templates in content | Suppress structural changes summaries unless explicitly requested |



### Read-Aloud Usability Check

Always run a mental read-aloud pass on the rewritten sentences to verify if the pacing, accents, and sentence length shifts feel natural.
