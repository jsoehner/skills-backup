...
- Before drafting textual headlines or scene kickers, you **MUST** read [copy-guide.md](references/copy-guide.md).
- Before registering cards into the index page, you **MUST** read [showcase-integration.md](references/showcase-integration.md).
- **Do NOT load** copy guidelines during frame extraction (Phase 2) to protect tokens context.

### CORS Server Errors & Disk Space Validation
