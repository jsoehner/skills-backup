...
### De-escalation & Emotion Management\\
If the other party becomes defensive, emotional, or shuts down:\\
1. Stop the discussion and state: "I see this is stressful. Let's take a 5-minute break and reconnect."\\
2. **NEVER** hold difficult workplace discussions over digital chat channels like Slack/Teams; always schedule a video call or coordinate face-to-face.\\

## References & Loading Triggers\\

**MANDATORY - LOADING TRIGGERS**:\\
- Before preparing details or script themes, you **MUST** read [preparation-template.md](references/preparation-template.md) and [delivery-scripts.md](references/delivery-scripts.md) to structure the opening lines.\\
- **Do NOT load** these templates for general peer status check-in meetings.\\
