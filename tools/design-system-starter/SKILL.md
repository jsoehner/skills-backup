...
| Avoid | Why | Instead |
|-------|-----|---------|
| Ad-hoc style values | Breaks design system consistency | Map to semantic token variables |
| Hiding focus outlines | Harms accessibility (keyboard nav) | Style accessible custom focus rings |
| Overcomplicating components with prop limits | Hard to maintain and adopt | Use component composition |

## References & Loading Triggers

**MANDATORY - LOADING TRIGGERS**:
- Before creating or styling components, you **MUST** read [component-examples.md](references/component-examples.md) fully to align props and styles.
