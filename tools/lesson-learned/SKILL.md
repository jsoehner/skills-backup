...
- Before starting Phase 3 analysis, you **MUST** read [se-principles.md](references/se-principles.md) fully.
- Before analyzing potential design mistakes or code errors, you **MUST** read [anti-patterns.md](references/anti-patterns.md).
- **Do NOT load** anti-patterns files if you are only highlighting structural patterns.

### Learning Ratios & System Limits
