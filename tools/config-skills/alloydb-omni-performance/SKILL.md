...
After a query performance analysis, execution plan generation, or database activity monitor report is completed, you **MUST** trigger the local memory capture. 
