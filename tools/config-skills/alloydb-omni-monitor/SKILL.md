...
After a database monitoring session, long-running transaction audit, or query performance analysis is completed, you **MUST** trigger the local memory capture. 
