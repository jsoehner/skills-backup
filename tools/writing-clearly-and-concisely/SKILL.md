...
- Before editing documentation paragraphs or structure in Step 20, you **MUST** read `03-elementary-principles-of-composition.md` fully.
- Before verifying grammar or co-ordinate clauses, you **MUST** read `02-elementary-rules-of-usage.md`.
- **Do NOT load** rules or misuse reference guides during draft scoping phases to save tokens.

### Passive Voice Limits & Word Count Reductions
