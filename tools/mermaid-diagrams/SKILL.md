...
| Avoid | Why | Instead |
|-------|-----|---------|
| Unquoted special chars in labels | Node syntax errors block rendering (e.g. parentheses or brackets) | Always quote labels containing special characters, e.g. `id["Label (Extra Info)"]` |
| Monolithic complex charts | Graphs with >25 nodes become visually unreadable | Split dense diagrams into logical sub-graphs |
| HTML elements inside labels | Breaks markdown parser interfaces | Avoid embedding raw HTML tags within node text blocks |
