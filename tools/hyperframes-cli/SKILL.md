...
- Before executing cloud deployments or rendering pipelines on AWS Lambda in Section 8, you **MUST** read `references/lambda.md` fully.

- Before checking workspace syntax patterns using static evaluation blocks, you **MUST** read `references/lint-validate-inspect.md`.

- **Do NOT load** target sub-reference markdown files during basic project setup checks to preserve token context.



### AWS Profiles & Chrome Recovery Checkpoints
