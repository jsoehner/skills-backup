...
- Before starting the ffmpeg frame extraction in Step 4, you **MUST** read [references/design-notes.md](references/design-notes.md) fully.
- Before editing typography styles in Step 5, you **MUST** read [references/landing-template.html](references/landing-template.html).
- **Do NOT load** design notes reference files during the initial video probing steps to save context tokens.

### HTTP Server CORS Warnings & Disk Storage Constraints
