...
### Atomic Skills
Located in the `tools/` directory, these are self-contained building blocks. They should not have dependencies on other skills in this repository.
...
4. **Atomic Skills**: Place in the appropriate sub-folder within `tools/`.
5. **Composite Skills**:
