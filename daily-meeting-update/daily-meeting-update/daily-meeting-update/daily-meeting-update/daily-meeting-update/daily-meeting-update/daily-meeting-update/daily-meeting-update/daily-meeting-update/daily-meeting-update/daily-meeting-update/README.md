...
### With AI coding agent History

```
Claude: "I can also pull your AI coding agent session history from yesterday.
This can help recall work that isn't in git/Jira. Want me to check?"
User: "Yes"

Claude: "Here are your AI coding agent sessions from yesterday.
...
- **AI coding agent** - For pulling session history (research, debugging, planning work not in git)
...
| Supported integrations | AI coding agent History, GitHub CLI, Git, Jira CLI, Atlassian MCP |
